...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
                                    ...
                                    try {
                                        ...
                                        foreach ($contactList as $item) {
                                            echo '  <tr>
                                                        ...
                                                        <td class="text-heading font-italic">' . ($item['replied'] == 1 ? 'ĐÃ TRẢ LỜI' : 'CHƯA PHẢN HỒI') . '</td>
                                                        
                                                        <td>
                                                                <a href="reply.php?id=' . $item['id'] . '">
    ...
    <script type="text/javascript">
        function deleteProduct(id) {
            var option = confirm('Bạn có chắc chắn muốn xoá tin nhắn này không?')
            if (!option) {
                return;
            }
