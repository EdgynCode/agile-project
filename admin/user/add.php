...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary toggle-eye" type="button" onclick="toggleVisibility('fullname')">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary toggle-eye" type="button" onclick="toggleVisibility('tendangnhap')">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary toggle-eye" type="button" onclick="toggleVisibility('email')">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary toggle-eye" type="button" onclick="toggleVisibility('diachi')">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <input required="true" type="text" class="form-control" id="matkhau" name="matkhau" value="<?= $matkhau ?>" readonly >
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary toggle-eye" type="button" onclick="toggleVisibility('dienthoai')">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
         window.onload = function() {
            toggleVisibility('fullname');
            toggleVisibility('tendangnhap');
            toggleVisibility('email');
            toggleVisibility('diachi');
            toggleVisibility('matkhau');
            toggleVisibility('dienthoai');
        };   
